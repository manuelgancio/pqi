...
CREATE TABLE `recibe` (
  ...
  `id_sus` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_cp`,`id_sus`),
  KEY `id_sus` (`id_sus`),
  CONSTRAINT `recibe_ibfk_1` FOREIGN KEY (`id_cp`) REFERENCES `pago` (`id_cp`),
  CONSTRAINT `recibe_ibfk_2` FOREIGN KEY (`id_sus`) REFERENCES `suscripcion` (`id_sus`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `seccion` (
  ...
  PRIMARY KEY (`id_s`),
  KEY `id_ed` (`id_ed`),
  CONSTRAINT `seccion_ibfk_1` FOREIGN KEY (`id_ed`) REFERENCES `edicion` (`id_ed`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-09-17 16:52:33
