...
<html lang="en">
  ...
  <div class="row">
    <div class="col-md-8">
      <section>      
        <h1 class="entry-title"><span>Cargar Noticia</span> </h1>
        <hr>
            <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" >        
        <div class="form-group">
          <label class="control-label col-sm-3">Titulo <span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
              <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              <input type="email" class="form-control" name="emailid" id="emailid" placeholder="Ingresa un titulo" value="">
            </div>
            <small> Este titulo sera cargado en la pagina principal. </small> </div>
        </div>
        
        <div class="form-group">
          <label class="control-label col-sm-3">Ingresa subtitulo<span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
              <input type="password" class="form-control" name="password" id="password" placeholder="Ingresa un subtitulo corto." value="">
           </div>   
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3">Autor <span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
              <input type="password" class="form-control" name="cpassword" id="cpassword" placeholder="Ingresa el autor" value="">
            </div>  
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3">Descripcion <span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-20">
            <input type="text" class="form-control" name="mem_name" id="mem_name" placeholder="Ingresa una descripcion" value="">
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3">Fecha en la que se publicara <span class="text-danger">*</span></label>
          <div class="col-xs-8">
        ...
        <div class="form-group">
          <label class="control-label col-sm-3">Cargar foto<br>
          <small>(500 x 250)</small></label>
          <div class="col-md-5 col-sm-8">
